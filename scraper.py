...
Revision History:
#       Date        By          Description
0.1.6	07/01/2018	Springer	Minor modifications to formatting/comments
0.1.5   06/30/2018  Springer    Modified scrape so it takes a session name as an
                                argument. Scrape method now produces a JSON file
                                for course data.
0.1.4   06/29/2018  Springer    Updated getSessions function so that a global
                                dictionary that maps the session name to the
                                session ID is added
0.1.3   06/28/2018  Springer    Added function to determine which sessions are
                                available Updated scrape function so that course
                                attributes are scraped and added to the course's
                                dictionary
0.1.1   06/26/2018  Springer    Added scrape function which opens connection to
